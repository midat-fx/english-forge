...
export function grammarLessonExperience(
  ...
  return {
    ...
    masteryCriterion: 'Тема отмечается освоенной после двух проверок 3/3 с интервалом не менее 12 часов и новым порядком вариантов, правильно исправленной типичной ошибки, подтверждённого собственного предложения и переноса в новый контекст не раньше чем через 12 часов с отдельным контрольным блоком 3/3 по той же конструкции. Приложение сохраняет эти свидетельства, но не притворяется, что автоматически оценило естественность ваших предложений.',
